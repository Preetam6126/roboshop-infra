...
{ name = "dev.shipping.cart_endpoint", value = "cart-dev.devops36.shop", type = "String"},
...
{ name = "dev.payment.cart_host", value = "8080", type = "String"},
{ name = "dev.payment.user_host", value = "user-dev.devops36.shop", type = "String"},
{ name = "dev.payment.user_host", value = "8080", type = "String"},
