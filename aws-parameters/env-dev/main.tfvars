parameters = [
{ name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devops36.shop:80/", type = "String"},
{ name = "dev.frontend.user_url", value = "http://user-dev.devops36.shop:80/", type = "String"},
{ name = "dev.frontend.cart_url", value = "http://cart-dev.devops36.shop:80/", type = "String"},
{ name = "dev.frontend.shipping_url", value = "http://shipping-dev.devops36.shop:80/", type = "String"},
{ name = "dev.frontend.payment_url", value = "http://payment-dev.devops36.shop:80/", type = "String"},
